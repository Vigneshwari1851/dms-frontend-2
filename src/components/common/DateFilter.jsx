    ...
    <div className="flex px-5 pt-5">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="flex gap-5 mt-4 pb-4 ml-2">
          ...
          <CalendarMini
            onDateSelect={(date) =>
              setFromDate(new Date(date.split("-").reverse().join("-")))
            }
          ...
          <CalendarMini
            onDateSelect={(date) =>
              setToDate(new Date(date.split("-").reverse().join("-")))
            }
            disabled={selectedOption !== "Custom"}
          />
      ...
      <div className="w-[180px] flex flex-col gap-3 ml-5 mt-5">
        {["Today", "Yesterday", "Last 7 days", "This month", "Custom"].map(
          (item) => (
            <div
              key={item}
              className={`text-[#B4B4B4] cursor-pointer hover:text-white text-[15px] ${
                selectedOption === item ? "text-white" : ""
              }`}
