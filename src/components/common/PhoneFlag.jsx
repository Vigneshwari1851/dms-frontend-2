const DIAL_TO_ISO2 = [
    ["+1684", "AS"], ["+1268", "AG"], ["+1264", "AI"], ["+1246", "BB"],
    ["+1242", "BS"], ["+1345", "KY"], ["+1441", "BM"], ["+1767", "DM"],
    ["+1809", "DO"], ["+1829", "DO"], ["+1849", "DO"], ["+1473", "GD"],
    ["+1671", "GU"], ["+1876", "JM"], ["+1664", "MS"], ["+1670", "MP"],
    ["+1787", "PR"], ["+1939", "PR"], ["+1869", "KN"], ["+1758", "LC"],
    ["+1784", "VC"], ["+1868", "TT"], ["+1649", "TC"], ["+1340", "VI"],
    ["+1", "US"],
    ["+20", "EG"], ["+211", "SS"], ["+212", "MA"], ["+213", "DZ"],
    ["+216", "TN"], ["+218", "LY"], ["+220", "GM"], ["+221", "SN"],
    ["+222", "MR"], ["+223", "ML"], ["+224", "GN"], ["+225", "CI"],
    ["+226", "BF"], ["+227", "NE"], ["+228", "TG"], ["+229", "BJ"],
    ["+230", "MU"], ["+231", "LR"], ["+232", "SL"], ["+233", "GH"],
    ["+234", "NG"], ["+235", "TD"], ["+236", "CF"], ["+237", "CM"],
    ["+238", "CV"], ["+239", "ST"], ["+240", "GQ"], ["+241", "GA"],
    ...
    ["+975", "BT"], ["+976", "MN"], ["+977", "NP"], ["+98", "IR"],
    ["+992", "TJ"], ["+993", "TM"], ["+994", "AZ"], ["+995", "GE"],
    ["+996", "KG"], ["+998", "UZ"],
];

function dialCodeToISO2(phone) {
    if (!phone) return null;
    const cleaned = phone.startsWith("+") ? phone : "+" + phone;
    for (const [code, iso2] of DIAL_TO_ISO2) {
        if (cleaned.startsWith(code)) return iso2;
    }
    return null;
}

export default function PhoneFlag({ phone, className = "" }) {
    if (!phone) {
        return (
    ...
    const iso2 = dialCodeToISO2(phone);
    const flagUrl = iso2
