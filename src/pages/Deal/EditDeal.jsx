...
export default function EditDeal() {
    ...
    return (
        <>
            {/* Page Header */}
            <div>
                <h2 className="text-[16px] font-medium text-white">Deal No- D001- Krishna</h2>
                <p className="text-gray-400 text-[12px] mb-6">
                    Edit and complete all required fields.
                </p>
            </div>
            ...
            "
                ...
                <div className="flex justify-end gap-3 mt-8">
                    ...
                    <button className="flex items-center gap-2 bg-[#1D4CB5] hover:bg-blue-600 h-10 text-white px-4 py-2 rounded-md text-sm font-medium cursor-pointer" onClick={() => navigate("/deals")}>
